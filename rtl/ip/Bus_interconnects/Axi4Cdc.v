...
module Axi_CDC64 (
  ...
  input  wire [63:0]   axiIn_wdata,
  input  wire [7:0]    axiIn_wstrb,
  ...
  output wire [63:0]   axiOut_wdata,
  output wire [7:0]    axiOut_wstrb,
  ...
  wire       [63:0]   wFifo_io_pop_payload_data;
  wire       [7:0]    wFifo_io_pop_payload_strb;
  ...
  wire       [63:0]   rFifo_io_pop_payload_data;
  ...
  StreamFifoCC_1 wFifo (
    ...
    .io_push_payload_data                 (axiIn_wdata[63:0]                            ), //i
    .io_push_payload_strb                 (axiIn_wstrb[7:0]                             ), //i
    .io_push_payload_last                 (axiIn_wlast                                  ), //i
    .io_pop_valid                         (wFifo_io_pop_valid                           ), //o
    .io_pop_ready                         (axiOut_wready                                ), //i
    .io_pop_payload_data                  (wFifo_io_pop_payload_data[63:0]              ), //o
    .io_pop_payload_strb                  (wFifo_io_pop_payload_strb[7:0]               ), //o
  ...
  StreamFifoCC_4 rFifo (
    ...
    .io_push_payload_data                 (axiOut_rdata[63:0]                          ), //i
    ...
    .io_pop_payload_data                  (rFifo_io_pop_payload_data[63:0]             ), //o
